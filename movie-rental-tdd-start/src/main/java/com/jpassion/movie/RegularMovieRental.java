...
public class RegularMovieRental implements MovieRentalCalculateable {
	
	private double FIRST_TIME_PERIOD_RATE = 2.00;
	private int FIRST_TIME_PERIOD_MAX_DAYS = 5;
	private double ADDITIONAL_DAYS_RATE = 3.00;
