...
public class NewReleaseMovieRental implements MovieRentalCalculateable {
	
	private double FIRST_TIME_PERIOD_RATE = 3.00;
	private int FIRST_TIME_PERIOD_MAX_DAYS = 3;
	private double ADDITIONAL_DAYS_RATE = 6.00;
